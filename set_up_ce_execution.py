...
if __name__ == '__main__':
    ...
    collection_instrument_controller.upload_seft_collection_instrument(bricks_201801_ce['id'], ci_path, '0001') # form type hard coded to 0001 for all ces to match sample file
    collection_instrument_controller.upload_seft_collection_instrument(bricks_201812_ce['id'], ci_path, '0001') # and CI File
