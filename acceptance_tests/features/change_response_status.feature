Feature: Change response status
  ...
  Scenario: Internal user can change the response status to Completed by phone
    Given the "Bricks" "204901" collection exercise for ru "49900000001" is in the "Not started" status
  ...
  Scenario: Internal user can change the response status to No Longer Required
    Given the "Bricks" "204901" collection exercise for ru "49900000002" is in the "Not started" status
