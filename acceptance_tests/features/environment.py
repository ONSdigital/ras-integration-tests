...
def before_all(context):
    ...
    database_controller.execute_ras_sql('resources/database/database_reset_party.sql', database_uri=Config.PARTY_DATABASE_URI)
    database_controller.execute_ras_sql('resources/database/database_reset_oauth.sql', database_uri=Config.DJANGO_OAUTH_DATABASE_URI)
    database_controller.execute_ras_sql('resources/database/database_reset_secure_message.sql', database_uri=Config.SECURE_MESSAGE_DATABASE_URI)
