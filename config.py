...
class Config(object):
    ...
    BACKSTAGE_UI_PORT = os.getenv('BACKSTAGE_UI_PORT', 4200)
    ...
    COLLECTION_EXERCISE = '{}://{}:{}'.format(PROTOCOL, COLLECTION_EXERCISE_SERVICE_HOST, COLLECTION_EXERCISE_SERVICE_PORT)
    ...
    FRONTSTAGE_SERVICE_PORT = os.getenv('FRONTSTAGE_SERVICE_PORT', 5001)
    ...
    PARTY_SERVICE_PORT = os.getenv('PARTY_SERVICE_PORT', 5062)
    ...
    RESPONSE_OPERATIONS_UI_COLLECTION_EXERCISE = '{}/surveys/{}'.format(RESPONSE_OPERATIONS_UI, '{}')
