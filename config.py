...
class Config(object):
    ...
    ACTION_EXPORTER = f'{PROTOCOL}://{ACTION_EXPORTER_HOST}:{ACTION_EXPORTER_PORT}'
    ...
    BACKSTAGE_SERVICE = f'{PROTOCOL}://{BACKSTAGE_SERVICE_HOST}:{BACKSTAGE_SERVICE_PORT}'

    BACKSTAGE_UI_HOST = os.getenv('BACKSTAGE_UI_HOST', 'localhost')
    BACKSTAGE_UI_PORT = os.getenv('BACKSTAGE_UI_PORT', 8050)
    BACKSTAGE_UI = f'{PROTOCOL}://{BACKSTAGE_UI_HOST}:{BACKSTAGE_UI_PORT}'
    ...
    COLLECTION_EXERCISE = f'{PROTOCOL}://{COLLECTION_EXERCISE_SERVICE_HOST}:{COLLECTION_EXERCISE_SERVICE_PORT}'
    ...
    FRONTSTAGE_API_SERVICE = f'{PROTOCOL}://{FRONTSTAGE_API_SERVICE_HOST}:{FRONTSTAGE_API_SERVICE_PORT}'
    ...
    CF_DATABASE_TOOL = f'{PROTOCOL}://{CF_DATABASE_TOOL_HOST}:{CF_DATABASE_TOOL_PORT}'
    ...
    SECURE_MESSAGE_DATABASE_URI = os.getenv('SECURE_MESSAGE_DATABASE_URI', "postgres://postgres:postgres@localhost:6433/postgres")
