...
INSERT INTO action.actionrule (id, actionrulepk, actionplanfk, actiontypefk, name, description, daysoffset, priority, id)
VALUES ('205f3512-eb6e-419d-81fb-d563f8b27bb3', 1000003, 1000002, 1, 'MBSENR', 'Enrolment', 0, 3, 'd24b3f17-bbf8-4c71-b2f0-a4334125d78b')
ON CONFLICT (actionrulepk) DO NOTHING;

INSERT INTO action.actionrule (id, actionrulepk, actionplanfk, actiontypefk, name, description, daysoffset, priority, id)
VALUES ('bc71fc5f-eac3-4d96-a04b-89c593a0e8b1', 1000004, 1000002, 2, 'MbSREM1', 'Enrolment Reminder', 45, 3, 'd24b3f17-bbf8-4c71-b2f0-a4334125d78c')
ON CONFLICT (actionrulepk) DO NOTHING;

INSERT INTO action.actionrule (id, actionrulepk, actionplanfk, actiontypefk, name, description, daysoffset, priority, id)
VALUES ('a1232e28-7268-481b-b0d0-b4cd8c49e5b1', 1000005, 1000003, 3, 'MbSREM2', 'Survey Reminder', 45, 3, 'd24b3f17-bbf8-4c71-b2f0-a4334125d78d')
ON CONFLICT (actionrulepk) DO NOTHING;
