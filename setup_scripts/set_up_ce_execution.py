...
if __name__ == '__main__':
    ...
    bricks_2018_ce = collection_exercise_controller.get_collection_exercise('cb8accda-6118-4d3b-85a3-149e28960c54', '201801')
    collection_instrument_controller.upload_collection_instrument(bricks_2018_ce['id'], 'resources/collection_instrument_files/064_0001_201803.xlsx')
